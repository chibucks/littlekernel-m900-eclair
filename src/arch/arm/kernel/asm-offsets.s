	...
	.eabi_attribute 18, 4
	.file	"asm-offsets.c"
@ GNU C (Buildroot 2010.02) version 4.3.4 (arm-linux-uclibcgnueabi)
@	compiled by GNU C version 4.4.3, GMP version 4.2.4, MPFR version 2.4.1-p5.
@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed:  -nostdinc -Iinclude
@ -I/home/john/sources/littlekernel-m900-eclair/src/kernel/arch/arm/include
...
@ /home/john/sources/toolchain-zefie/usr/bin/../lib/gcc/arm-linux-uclibcgnueabi/4.3.4/
@ -D__KERNEL__ -D__LINUX_ARM_ARCH__=6 -Uarm -DKBUILD_STR(s)=#s
@ -DKBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -DKBUILD_MODNAME=KBUILD_STR(asm_offsets) -isystem
@ /home/john/sources/toolchain-zefie/usr/bin/../lib/gcc/arm-linux-uclibcgnueabi/4.3.4/include
...
@ -ftree-vrp -funit-at-a-time -fverbose-asm -fwrapv
@ -fzero-initialized-in-bss -mapcs-frame -mlittle-endian -muclibc

@ Compiler executable checksum: b0885ef1d63f0fe0624092a34b277af4
...
@ 0 "" 2
	...
	ldmfd	sp, {fp, sp, pc}	@
	.size	main, .-main
	.ident	"GCC: (Buildroot 2010.02) 4.3.4"
